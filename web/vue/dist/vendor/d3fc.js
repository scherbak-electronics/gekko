(function (global, factory) {
    ...
    var lineShader = (function () {
      ...
      fragmentShader.appendHeader(line$1.header).appendBody(line$1.body);
      return {
        vertex: function vertex() {
          return vertexShader;
        },
    ...
    var identity$3 = d3Scale.scaleIdentity(); // offset date values to make the most of the float32 precision
    ...
    customElements.define('d3fc-canvas', _default$1);
